...
var Main = function() {
	...
	this.gameHeight = flash.Lib.get_current().get_stage().get_stageWidth();
	this.gameWidth = flash.Lib.get_current().get_stage().get_stageHeight();
...
var DefaultAssetLibrary = function() {
	...
	this.add("assets/font.ttf",openfl.AssetType.FONT);
...
GameController.__super__ = flixel.FlxBasic;
GameController.prototype = $extend(flixel.FlxBasic.prototype,{
	_up: null
	,_down: null
	,_left: null
	,_right: null
	,checkInput: function() {
		if(flixel.FlxG.keys.checkStatus(68,flixel.FlxG.keys.justPressed.checkStatus)) this._right = true; else if(flixel.FlxG.keys.checkStatus(83,flixel.FlxG.keys.justPressed.checkStatus)) this._down = true; else if(flixel.FlxG.keys.checkStatus(65,flixel.FlxG.keys.justPressed.checkStatus)) this._left = true; else if(flixel.FlxG.keys.checkStatus(87,flixel.FlxG.keys.justPressed.checkStatus)) this._up = true;
	}
...
GameOverState.__super__ = flixel.FlxState;
GameOverState.prototype = $extend(flixel.FlxState.prototype,{
	btnPlay: null
	,create: function() {
		var canvas = new flixel.FlxSprite();
		canvas.makeGraphic(flixel.FlxG.width,flixel.FlxG.height,0,true);
		flixel.util.FlxSpriteUtil.drawRect(canvas,120,10,10,10,-663885);
		flixel.util.FlxSpriteUtil.drawRect(canvas,120,20,10,10,-16744320);
		this.add(canvas);
		var currentScore;
		var currentScore1 = "Your score is  " + Std.string(Main.globalScore);
		var introText1 = new flixel.text.FlxText(10,10,220,"You are this person ");
		var introText2 = new flixel.text.FlxText(10,50,220,"Move around so that you are distinct from other tiles");
		var scoreText = new flixel.text.FlxText(10,10,220,currentScore1);
		scoreText.setFormat("assets/font.ttf",15,-1,"center");
		this.btnPlay = new flixel.ui.FlxButton(0,0,"Replay",$bind(this,this.clickReplay));
		flixel.util.FlxSpriteUtil.screenCenter(this.btnPlay);
		flixel.util.FlxSpriteUtil.screenCenter(scoreText);
		this.btnPlay.set_y(this.btnPlay.y + 40);
	...
	,destroy: function() {
		...
		this.btnPlay = flixel.util.FlxDestroyUtil.destroy(this.btnPlay);
	}
	,update: function() {
...
var MenuState = function(MaxSize) {
	this.stagWidth = flash.Lib.get_current().get_stage().get_stageWidth();
	this.stagHeight = flash.Lib.get_current().get_stage().get_stageHeight();
	flixel.FlxState.call(this,MaxSize);
};
...
PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,checkTrue: function() {
		...
		if(this._tileHead.arrVert != -1) {
			if(this.tileMap[this._tileHead.arrVert].tileColor == this._tileHead.tileColor) this.isGameOver = true;
		}
		if(this._tileHead.arrRight != -1) {
			if(this.tileMap[this._tileHead.arrRight].tileColor == this._tileHead.tileColor) this.isGameOver = true;
		}
		if(this._tileHead.arrLeft != -1) {
			if(this.tileMap[this._tileHead.arrLeft].tileColor == this._tileHead.tileColor) this.isGameOver = true;
		}
		if(this._tileBody.arrVert != -1) {
			if(this.tileMap[this._tileBody.arrVert].tileColor == this._tileBody.tileColor) this.isGameOver = true;
		}
		if(this._tileBody.arrRight != -1) {
			if(this.tileMap[this._tileBody.arrRight].tileColor == this._tileBody.tileColor) this.isGameOver = true;
		}
		if(this._tileBody.arrLeft != -1) {
			if(this.tileMap[this._tileBody.arrLeft].tileColor == this._tileBody.tileColor) this.isGameOver = true;
		}
		...
		if(this.isGameOver == true) this.myTimer = new flixel.util.FlxTimer(2.0,$bind(this,this.gameOver),1);
	}
	,gameOver: function(Timer) {
		Main.globalScore = this.myScore;
		this.myScore = 0;
		flixel.FlxG.switchState(new GameOverState());
	}
	,moveUp: function() {
		if(this._tileHead.arrVert != -1) {
			this.tileMap[this._tileHead.arrVert].setTilePosition(this._tileBody.tilePosx,this._tileBody.tilePosy);
			this.tileMap[this._tileHead.arrVert].tweenPosition();
		}
		if(this._tileBody.arrVert != -1) this.tileMap[this._tileBody.arrVert].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrRight != -1) this.tileMap[this._tileBody.arrRight].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrLeft != -1) this.tileMap[this._tileBody.arrLeft].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		this.tileMap[this._tileBody.arrPos] = this.tileMap[this._tileHead.arrVert];
		this._tileHead.setTilePosition(this._tileHead.tilePosx,this._tileHead.tilePosy - 1);
		this._tileBody.setTilePosition(this._tileBody.tilePosx,this._tileBody.tilePosy - 1);
		this.checkTrue();
	}
	,moveDown: function() {
		if(this._tileHead.arrVert != -1) this.tileMap[this._tileHead.arrVert].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileHead.arrRight != -1) this.tileMap[this._tileHead.arrRight].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileHead.arrLeft != -1) this.tileMap[this._tileHead.arrLeft].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrVert != -1) {
			this.tileMap[this._tileBody.arrVert].setTilePosition(this._tileHead.tilePosx,this._tileHead.tilePosy);
			this.tileMap[this._tileBody.arrVert].tweenPosition();
		}
		this.tileMap[this._tileHead.arrPos] = this.tileMap[this._tileBody.arrVert];
		this._tileHead.setTilePosition(this._tileHead.tilePosx,this._tileHead.tilePosy + 1);
		this._tileBody.setTilePosition(this._tileBody.tilePosx,this._tileBody.tilePosy + 1);
		this.checkTrue();
	}
	,moveRight: function() {
		if(this._tileHead.arrVert != -1) this.tileMap[this._tileHead.arrVert].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileHead.arrRight != -1) {
			this.tileMap[this._tileHead.arrRight].setTilePosition(this._tileHead.tilePosx,this._tileHead.tilePosy);
			this.tileMap[this._tileHead.arrRight].tweenPosition();
		}
		if(this._tileHead.arrLeft != -1) this.tileMap[this._tileHead.arrLeft].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrVert != -1) this.tileMap[this._tileBody.arrVert].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrRight != -1) {
			this.tileMap[this._tileBody.arrRight].setTilePosition(this._tileBody.tilePosx,this._tileBody.tilePosy);
			this.tileMap[this._tileBody.arrRight].tweenPosition();
		}
		if(this._tileBody.arrLeft != -1) this.tileMap[this._tileBody.arrLeft].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		this.tileMap[this._tileHead.arrPos] = this.tileMap[this._tileHead.arrRight];
		this.tileMap[this._tileBody.arrPos] = this.tileMap[this._tileBody.arrRight];
		this._tileHead.setTilePosition(this._tileHead.tilePosx + 1,this._tileHead.tilePosy);
		this._tileBody.setTilePosition(this._tileBody.tilePosx + 1,this._tileBody.tilePosy);
		this.checkTrue();
	}
	,moveLeft: function() {
		if(this._tileHead.arrVert != -1) this.tileMap[this._tileHead.arrVert].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileHead.arrRight != -1) this.tileMap[this._tileHead.arrRight].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileHead.arrLeft != -1) {
			this.tileMap[this._tileHead.arrLeft].setTilePosition(this._tileHead.tilePosx,this._tileHead.tilePosy);
			this.tileMap[this._tileHead.arrLeft].tweenPosition();
		}
		if(this._tileBody.arrVert != -1) this.tileMap[this._tileBody.arrVert].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrRight != -1) this.tileMap[this._tileBody.arrRight].updateColor(flixel.util.FlxRandom.intRanged(0,9));
		if(this._tileBody.arrLeft != -1) {
			this.tileMap[this._tileBody.arrLeft].setTilePosition(this._tileBody.tilePosx,this._tileBody.tilePosy);
			this.tileMap[this._tileBody.arrLeft].tweenPosition();
		}
		this.tileMap[this._tileHead.arrPos] = this.tileMap[this._tileHead.arrLeft];
		this.tileMap[this._tileBody.arrPos] = this.tileMap[this._tileBody.arrLeft];
		this._tileHead.setTilePosition(this._tileHead.tilePosx - 1,this._tileHead.tilePosy);
		this._tileBody.setTilePosition(this._tileBody.tilePosx - 1,this._tileBody.tilePosy);
		this.checkTrue();
	}
	,create: function() {
		this.myScore = 0;
		this.scoreText = new flixel.text.FlxText(120,20,120,"Your Score");
		this._tileHead = new PlayerTile(2,1,0);
		this._tileBody = new PlayerTile(2,2,1);
		this._tileHead.updatePosition();
		this._tileBody.updatePosition();
		flixel.util.FlxSpriteUtil.drawCircle(this._tileHead,30,30,5,858993459);
		flixel.util.FlxSpriteUtil.drawRect(this._tileBody,25,25,10,10,858993459);
		this._tile1 = new Tile(0,0,flixel.util.FlxRandom.intRanged(0,9));
		this._tile2 = new Tile(1,0,flixel.util.FlxRandom.intRanged(0,9));
		this._tile3 = new Tile(2,0,flixel.util.FlxRandom.intRanged(1,9));
		this._tile4 = new Tile(3,0,flixel.util.FlxRandom.intRanged(0,9));
		this._tile5 = new Tile(0,1,flixel.util.FlxRandom.intRanged(0,9));
		this._tile6 = new Tile(1,1,flixel.util.FlxRandom.intRanged(1,9));
		this._tile7 = new Tile(3,1,flixel.util.FlxRandom.intRanged(1,9));
		this._tile8 = new Tile(0,2,flixel.util.FlxRandom.intRanged(0,9));
		this._tile9 = new Tile(1,2,flixel.util.FlxRandom.intRanged(2,10));
		this._tile10 = new Tile(3,2,flixel.util.FlxRandom.intRanged(2,10));
		this._tile11 = new Tile(0,3,flixel.util.FlxRandom.intRanged(0,9));
		this._tile12 = new Tile(1,3,flixel.util.FlxRandom.intRanged(0,9));
		this._tile13 = new Tile(2,3,flixel.util.FlxRandom.intRanged(2,10));
		this._tile14 = new Tile(3,3,flixel.util.FlxRandom.intRanged(0,9));
		...
		this._tileHead.playerAdjacents();
		this._tileBody.playerAdjacents();
		this.tileMap = [this._tile1,this._tile2,this._tile3,this._tile4,this._tile5,this._tile6,this._tileHead,this._tile7,this._tile8,this._tile9,this._tileBody,this._tile10,this._tile11,this._tile12,this._tile13,this._tile14];
		flixel.FlxState.prototype.create.call(this);
	}
	,destroy: function() {
		flixel.FlxState.prototype.destroy.call(this);
		this._tileHead = flixel.util.FlxDestroyUtil.destroy(this._tileHead);
		this._tileBody = flixel.util.FlxDestroyUtil.destroy(this._tileBody);
		this._tile1 = flixel.util.FlxDestroyUtil.destroy(this._tile1);
		this._tile2 = flixel.util.FlxDestroyUtil.destroy(this._tile2);
		this._tile3 = flixel.util.FlxDestroyUtil.destroy(this._tile3);
		this._tile4 = flixel.util.FlxDestroyUtil.destroy(this._tile4);
		this._tile5 = flixel.util.FlxDestroyUtil.destroy(this._tile5);
		this._tile6 = flixel.util.FlxDestroyUtil.destroy(this._tile6);
		this._tile7 = flixel.util.FlxDestroyUtil.destroy(this._tile7);
		this._tile8 = flixel.util.FlxDestroyUtil.destroy(this._tile8);
		this._tile9 = flixel.util.FlxDestroyUtil.destroy(this._tile9);
		this._tile10 = flixel.util.FlxDestroyUtil.destroy(this._tile10);
		this._tile11 = flixel.util.FlxDestroyUtil.destroy(this._tile11);
		this._tile12 = flixel.util.FlxDestroyUtil.destroy(this._tile12);
		this._tile13 = flixel.util.FlxDestroyUtil.destroy(this._tile13);
		this._tile14 = flixel.util.FlxDestroyUtil.destroy(this._tile14);
	}
	,update: function() {
		this.scoreText.set_text(Std.string(this.myScore));
		if(this.isGameOver == false) {
			this.myController.checkInput();
			if(this.myController._up && this._tileHead.tilePosy != 0) this.moveUp();
			if(this.myController._down && this._tileHead.tilePosy != 2) this.moveDown();
			if(this.myController._right && this._tileHead.tilePosx != 3) this.moveRight();
			if(this.myController._left && this._tileHead.tilePosx != 0) this.moveLeft();
		}
		flixel.FlxState.prototype.update.call(this);
	}
	,__class__: PlayState
...
var Tile = function(X,Y,Z) {
	...
	this.tileColor = 0;
	this.arrPos = 0;
	this.colorArray = [-663885,-16744320,-8388864,-2354116,-14513374,-34817,-11861886,-4882724,-3952495,-2448096,-663885];
	var tileX;
	tileX = js.Boot.__cast(X * 60 , Int);
	var tileY;
	tileY = js.Boot.__cast(Y * 60 + 80 , Int);
	flixel.FlxSprite.call(this,tileX,tileY);
	this.tilePosx = X;
	this.tilePosy = Y;
	this.arrPos = Y * 4 + X;
	this.tileColor = Z;
	var colour = this.colorArray[Z];
	this.makeGraphic(60,60,colour,true);
};
$hxClasses["Tile"] = Tile;
Tile.__name__ = ["Tile"];
Tile.__super__ = flixel.FlxSprite;
Tile.prototype = $extend(flixel.FlxSprite.prototype,{
	colorArray: null
	,tilePosx: null
	,tilePosy: null
	,arrPos: null
	...
	,updateColor: function(X) {
		if(X == null) X = 0;
		this.tileColor = X;
		var colour = this.colorArray[X];
		this.makeGraphic(60,60,colour,true);
	}
	,updatePosition: function() {
		this.set_x(this.tilePosx * 60);
		this.set_y(this.tilePosy * 60 + 80);
		this.arrPos = this.tilePosy * 4 + this.tilePosx;
	}
	,tweenPosition: function() {
		flixel.tweens.FlxTween.tween(this,{ x : this.tilePosx * 60, y : this.tilePosy * 60 + 80},0.2,{ ease : flixel.tweens.FlxEase.expoOut});
		this.arrPos = this.tilePosy * 4 + this.tilePosx;
	}
	,__class__: Tile
});
var PlayerTile = function(X,Y,Z) {
	if(Z == null) Z = 0;
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	this.posChange = new flixel.util.FlxPoint(0,0);
	this.arrRight = 16;
	this.arrLeft = 16;
	this.arrVert = 16;
	this.isHead = false;
	...
	this.arrPos = Y * 4 + X;
	if(Z == 0) {
		this.makeGraphic(60,60,-663885,true);
		this.isHead = true;
		this.tileColor = 0;
	} else {
		this.makeGraphic(60,60,-16744320,true);
		this.isHead = false;
		this.tileColor = 1;
	}
};
$hxClasses["PlayerTile"] = PlayerTile;
PlayerTile.__name__ = ["PlayerTile"];
PlayerTile.__super__ = Tile;
PlayerTile.prototype = $extend(Tile.prototype,{
	isHead: null
	,arrVert: null
	,arrLeft: null
	,arrRight: null
	,posChange: null
	,playerAdjacents: function() {
		if(this.isHead == true) {
			if(this.tilePosy != 0) this.arrVert = this.arrPos - 4; else this.arrVert = -1;
			if(this.tilePosx != 3) this.arrRight = this.arrPos + 1; else this.arrRight = -1;
			if(this.tilePosx != 0) this.arrLeft = this.arrPos - 1; else this.arrLeft = -1;
		}
		if(this.isHead == false) {
			if(this.tilePosy != 3) this.arrVert = this.arrPos + 4; else this.arrVert = -1;
			if(this.tilePosx != 3) this.arrRight = this.arrPos + 1; else this.arrRight = -1;
			if(this.tilePosx != 0) this.arrLeft = this.arrPos - 1; else this.arrLeft = -1;
		}
	}
	,__class__: PlayerTile
});
...
haxe.Resource.content = [{ name : "__ASSET__assets_font_ttf", data : ""}];
...
ApplicationMain.config = { antialiasing : 0, background : 10199205, borderless : false, depthBuffer : false, fps : 60, fullscreen : false, height : 480, orientation : "portrait", resizable : true, stencilBuffer : false, title : "IdCrisis2", vsync : true, width : 640};
