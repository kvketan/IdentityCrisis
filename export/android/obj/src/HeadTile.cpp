...
Void HeadTile_obj::__construct(hx::Null< int >  __o_X,hx::Null< int >  __o_Y,hx::Null< int >  __o_Z)
{
HX_STACK_FRAME("HeadTile","new",0xdfb5ec80,"HeadTile.new","HeadTile.hx",7,0x73cd22f0)
HX_STACK_THIS(this)
...
//HeadTile_obj::~HeadTile_obj() { }

Dynamic HeadTile_obj::__CreateEmpty() { return  new HeadTile_obj; }
hx::ObjectPtr< HeadTile_obj > HeadTile_obj::__new(hx::Null< int >  __o_X,hx::Null< int >  __o_Y,hx::Null< int >  __o_Z)
{  hx::ObjectPtr< HeadTile_obj > result = new HeadTile_obj();
	result->__construct(__o_X,__o_Y,__o_Z);
	return result;}

Dynamic HeadTile_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< HeadTile_obj > result = new HeadTile_obj();
	result->__construct(inArgs[0],inArgs[1],inArgs[2]);
	return result;}

Void HeadTile_obj::playerAdjacents( ){
{
		HX_STACK_FRAME("HeadTile","playerAdjacents",0xa4f82df0,"HeadTile.playerAdjacents","HeadTile.hx",18,0x73cd22f0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(19)
		if (((this->isHead == true))){
			HX_STACK_LINE(21)
...
HX_DEFINE_DYNAMIC_FUNC0(HeadTile_obj,playerAdjacents,(void))
...
void HeadTile_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(HeadTile);
...
void HeadTile_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic HeadTile_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic HeadTile_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
...
void HeadTile_obj::__GetFields(Array< ::String> &outFields)
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(HeadTile_obj,isHead),HX_CSTRING("isHead")},
	{hx::fsInt,(int)offsetof(HeadTile_obj,arrVert),HX_CSTRING("arrVert")},
	{hx::fsInt,(int)offsetof(HeadTile_obj,arrLeft),HX_CSTRING("arrLeft")},
	{hx::fsInt,(int)offsetof(HeadTile_obj,arrRight),HX_CSTRING("arrRight")},
	{hx::fsObject /*::flixel::util::FlxPoint*/ ,(int)offsetof(HeadTile_obj,posChange),HX_CSTRING("posChange")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(HeadTile_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(HeadTile_obj::__mClass,"__mClass");
};

#endif

Class HeadTile_obj::__mClass;

void HeadTile_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("HeadTile"), hx::TCanCast< HeadTile_obj> ,sStaticFields,sMemberFields,
