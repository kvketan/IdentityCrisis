...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(16)
	this->gameHeight = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageHeight();
	HX_STACK_LINE(15)
	this->gameWidth = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth();
	HX_STACK_LINE(35)
	super::__construct();
	HX_STACK_LINE(37)
...
{
		HX_STACK_FRAME("Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",58,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(59)
...
int Main_obj::globalScore;

Void Main_obj::main( ){
{
		HX_STACK_FRAME("Main","main",0xed0e206e,"Main.main","Main.hx",29,0x087e5c05)
		HX_STACK_LINE(30)
...
Dynamic Main_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"globalScore") ) { return globalScore; }
		break;
	case 12:
...
Dynamic Main_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"globalScore") ) { globalScore=inValue.Cast< int >(); return inValue; }
		break;
	case 12:
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Main_obj::globalScore,"globalScore");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Main_obj::__mClass,"__mClass");
	HX_VISIT_MEMBER_NAME(Main_obj::globalScore,"globalScore");
};
